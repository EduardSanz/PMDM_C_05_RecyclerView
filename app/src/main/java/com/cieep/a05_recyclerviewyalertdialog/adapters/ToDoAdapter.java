...
public class ToDoAdapter extends RecyclerView.Adapter<ToDoAdapter.ToDoVH> {
    ...
    public void onBindViewHolder(@NonNull ToDoVH holder, int position) {
        ...
        holder.btnCompletado.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                confirmUpdate("SEGURO, SEGUUUUURO", toDo)
                        .show();
            }
        });
    ...
    private AlertDialog confirmDelete(String titulo, int posicion) {
        ...
        builder.setPositiveButton("SIIII", new DialogInterface.OnClickListener() {
            @Override
    ...
    public class ToDoVH extends RecyclerView.ViewHolder {
        ...
        public ToDoVH(@NonNull View itemView) {
            ...
            lblContenido = itemView.findViewById(R.id.lblContendidoToDoViewModel);
